...
describe('step 2', () => {
  ...
  test('lastName is Stevenson', () => {
    expect(values.lastName).toEqual('Sainz');
  });
  ...
  test('greeting is properly output', () => {
    expect(values.greeting).toEqual('Hello! My name is Carlos Sainz and I am 18 years old.');
  });
});

describe('step 3', () => {
  test('fullName is Carlos Stevenson', () => {
    expect(values.fullName).toEqual('Carlos Sainz');
  });
  test('age is 18', () => {
